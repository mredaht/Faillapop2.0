...
contract FP_Vault is IFP_Vault, AccessControl {
    ...
    /**
        @notice Event emitted when a user stakes funds
    ...
    */
    ...
    /**
        @notice Event emitted when a user unstakes funds
        @param user The address of the user
    ...
    */
    ...
    /**
        @notice Event emitted when funds are locked
        @param user The address of the user
    ...
    */
    ...
    /**
        @notice Event emitted when funds are unlocked
        @param user The address of the user
    ...
    */
    ...
    /**
        @notice Event emitted when funds are slashed
        @param user The address of the user
