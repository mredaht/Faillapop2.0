...
contract FP_PowersellerNFT is IFP_PowersellerNFT, ERC721, AccessControl {
    ...
    /**
        @notice Event emitted when a PowerSeller NFT is minted for a user
        @param minter The address that triggered the mint
        @param tokenId The ID of the minted token
    */
    event PowersellerNFT_Minted(address indexed minter, uint256 indexed tokenId);

    /**
        @notice Event emitted when a PowerSeller NFT is removed from a user
        @param remover The address that triggered the removal
        @param tokenId The ID of the removed token
    */
    event PowersellerNFT_Removed(address indexed remover, uint256 indexed tokenId);
