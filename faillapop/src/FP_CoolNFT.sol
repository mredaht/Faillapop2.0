...
contract FP_CoolNFT is IFP_CoolNFT, ERC721, AccessControl {
    ...
    /**
        @notice Event emitted when a Cool NFT is minted for a user
        @param to The address of the user that received the Cool NFT
        @param tokenId The ID of the minted token
    */
    event CoolNFT_Minted(address indexed to, uint256 indexed tokenId);

    /**
        @notice Event emitted when all Cool NFTs are slashed from a user
        @param owner The address of the user that lost their Cool NFTs
    */
